...
namespace Amiable.Core
{
    public static partial class Export
    {
        ...
        [DllExport]//群事件-群成员增加
        public static int _eventSystem_GroupMemberIncrease(int subType, int sendTime, long group,
        ...
        public static int _eventGroupCard_Changed(int subType, int sendTime, long group, long userId,string newCard,string oldCard)
        {
            return 0;
        }
        [DllExport]//请求-好友添加
