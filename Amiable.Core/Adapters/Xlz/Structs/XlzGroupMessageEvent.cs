...
namespace Amiable.Core.Adapters.Xlz.Structs
{
    ...
    public struct XlzGroupMessageEvent
    {
        ...
        /// 发送人群名片 没有名片则为空白
        /// </summary>
        [MarshalAs(UnmanagedType.LPStr)] public string SenderNickname;
        ...
        /// 发送人群头衔
        /// </summary>
        [MarshalAs(UnmanagedType.LPStr)] public string SenderTitle;
        ...
        /// 回复对象消息内容 如果是回复消息
        /// </summary>
        [MarshalAs(UnmanagedType.LPStr)] public string ReplyMessageContent;
        ...
        /// 文件Id
        /// </summary>
        [MarshalAs(UnmanagedType.LPStr)] public string FileID;

        // 文件Md5
        /// <summary>
        /// 文件Md5
        /// </summary>
        [MarshalAs(UnmanagedType.LPStr)] public string FileMD5;
